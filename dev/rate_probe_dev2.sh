#!/bin/bash
# Two more DEVICE-path points (BFD_DEVICE_PQR=1) (10k, 15k) to confirm the 5k/20k slope is linear.
...
# ONE JAX job at a time: wait out the host 10k/15k probe's shell, then any stragglers.
while [ -d /proc/917556 ]; do sleep 20; done
