...
# RERUN after fixing the antithetic pairing bug (shear._antithetic).  The old
# run at logs/batch_probe/ was taken with a broken NLL term: +g and -g landed
# on different templates and the effective batch was half.  Not comparable.
#
